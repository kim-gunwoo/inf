...
const Images: NextPage = () => {
  return (
    <main>
      ...
      <figure>
        <Image
          src={example} //  static하게 import 할 경우 빌드 타임에서 최적화를 진행할 수 있음
          alt="v13 image"
          // width={500}
          // height={100}
          placeholder="blur"
      ...
      {/*  <figcaption>v13 image</figcaption>*/}
      {/*</figure>*/}
      <div>이미지 크기를 모를 경우 아래와 같이 처리한다.</div>
      ...
      v13 image fill objectFit cover
      <hr style={{ margin: '32px 0' }} />
      <br />
      <h1>next/legacy/image</h1>
      <div>
        v13 은 단순 img 태그로 되어있으나 이전 레거시는 다른 태그들로 감싸져
        있음
      </div>
      {/** statically import */}
      <figure>
